package clase_16.extra.collection.set.linked_hash_set;

import clase_16.extra.collection.Libro;

import java.util.LinkedHashSet;

public class Programa_c16_linked_hash_set {
    public static void main(String[] args) {
        // CARACTERISTICAS:
        //      Implementa la interface Set (java.util).
        //      Es un conjunto de objetos doblemente enlazados (internamente, usa una instancia de LinkedHashMap).
